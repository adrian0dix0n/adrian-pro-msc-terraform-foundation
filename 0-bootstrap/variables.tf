...
variable "groups" {
  ...
  type = object({
    ...
    required_groups = object({
      group_org_admins           = org-admins@atdomain.org
      group_billing_admins       = billing-admins@atdomain.org
      billing_data_users         = billing-data@atdomain.org
      audit_data_users           = audit-data@atdomain.org
      monitoring_workspace_users = monitoring-workspace@atdomain.org
    })
